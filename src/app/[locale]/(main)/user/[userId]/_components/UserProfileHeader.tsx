...
const UserProfileHeader = ({ nickName, profileImgUrl }: UserProfileHeaderProps) => {
  ...
  return (
    <section aria-label={`${nickName}의 프로필`} className="sticky top-0 z-10 bg-black px-5 pt-5">
      <div className="flex h-[66px] items-center justify-between gap-4 bg-neutral-800">
        ...
        <div
          className="group h-full w-10 flex-shrink-0 cursor-pointer flex-center fanmix-gradient"
